...
$.jStorage.set('profile', {
	...
	'connection' : {
		...
		'http://' : {
			description : {
				en : 'demo met lokale triplestore'
			},
			useForInverseSameAs : true,
			/*change this*/
			endpoint : 'http://localhost:8080/openrdf-sesame/repositories/areaaldata',
			examples : [{
				label : 'Wegelement Fietsverkeer',
				uri : 'http://otl.noord-holland.nl#Wegelement_Fietsverkeer'
			}, {
				label : 'Wegdeel_v',
				uri : 'http://areaaldata.noord-holland.nl#wegdeel_v'
			}]
		}
	},
	arrows : {
	...
	'default' : {
		...
		images : {
			properties : ['http://www.w3.org/2006/vcard/ns#photo', 'http://xmlns.com/foaf/0.1/depiction','http://xmlns.com/foaf/0.1/image', 'http://dbpedia.org/ontology/thumbnail', 'http://dbpedia.org/property/logo', 'http://linkedgeodata.org/ontology/schemaIcon']
		},
		maps : {
...
$.jStorage.set('endpoints', {
	all : 'Accept=application/sparql-results%2Bjson&output=json&format=application/json&timeout=0',
